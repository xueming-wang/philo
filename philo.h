...
/*   Updated: 2021/08/04 18:47:53 by xuwang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    philo_state(t_philo *philo, t_each_philo *each_philo, int state);
void    *do_philo(void *each_philo);
void   ft_philo(t_philo *philo, t_each_philo *each_philo);
void    ft_usleep(long long ms);
int     check_died(t_philo *philo, t_each_philo *each_philo);
int     check_enough_eat(t_philo *philo, t_each_philo *each_philo);
